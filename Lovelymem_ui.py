...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_load_netstat.setGeometry(QRect(620, 10, 75, 23))
        ...
        self.pushButton_load_netstat_timeline.setGeometry(QRect(620, 40, 111, 23))
        ...
        self.pushButton_load_proc_timeline.setGeometry(QRect(740, 40, 111, 23))
        self.pushButton_load_proc = QPushButton(self.centralwidget)
        self.pushButton_load_proc.setObjectName(u"pushButton_load_proc")
        self.pushButton_load_proc.setGeometry(QRect(700, 10, 75, 23))
        ...
        self.pushButton_load_tasks.setGeometry(QRect(780, 10, 75, 23))
        ...
        self.pushButton_load_findevil.setGeometry(QRect(860, 10, 75, 23))
        ...
        self.pushButton_load_web_timeline.setGeometry(QRect(860, 40, 111, 23))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"LovelyMem v0.1", None))
