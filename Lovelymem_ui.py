...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget_find.setGeometry(QRect(10, 40, 1691, 611))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1709, 21))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"LovelyMem", None))
