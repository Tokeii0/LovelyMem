...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_load_netstat.setGeometry(QRect(680, 10, 75, 23))
        ...
        self.pushButton_load_netstat_timeline.setGeometry(QRect(680, 40, 111, 23))
        ...
        self.pushButton_load_proc_timeline.setGeometry(QRect(790, 40, 111, 23))
        self.pushButton_load_proc = QPushButton(self.centralwidget)
        self.pushButton_load_proc.setObjectName(u"pushButton_load_proc")
        self.pushButton_load_proc.setGeometry(QRect(760, 10, 75, 23))
        ...
        self.pushButton_load_tasks.setGeometry(QRect(840, 10, 75, 23))
        ...
        self.pushButton_load_findevil.setGeometry(QRect(920, 10, 75, 23))
        ...
        self.pushButton_load_web_timeline.setGeometry(QRect(900, 40, 111, 23))
